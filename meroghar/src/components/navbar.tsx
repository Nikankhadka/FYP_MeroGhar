...
import Image from "next/image"
 ...
 const NavBar=():JSX.Element=>{
    ...
    return(
        <nav className="shadow-none md:shadow-md w-full p-1 flex justify-around items-center">
            {/* logoName */}
            
            <div className="flex  items-end gap-1">
            <a href="http://localhost:3000" className=" block hidden md:flex items-center gap-1 ">
                <img src="airbnb.png" alt="logo" className="h-9 w-9 block" />
                </a>

            <a href="http://localhost:3000" className=" md:text-sm text-mainColor font-semibold drop-shadow-xl ">MeroGhar
                </a>
            </div>
           ...
           {/* post and Profile */}
            ...
            <a href="http://localhost:2900/postRoom" className=" block md:text-xs text-gray-700 font-bold  p-2 px-3 rounded hover:bg-gray-100">Postroom</a>
