...
import { getBookingS, postBookingS,getMyBookingS } from "../../services/property/booking.service";
...
export const getBookingC=async(req:Request,res:Response)=>{
    try{
        ...
        const reservations=await getBookingS(req.params.id,req.userData.userId,page,limit);
